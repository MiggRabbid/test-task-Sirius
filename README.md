...
6. Для демонстрации состояний добавлены переключатели `variant`, `clickable` и `WidthSwitcher`.
...
├── src
│   ├── app                           // Корневой компонент и app-уровень
│   │   ├── App.tsx                   // Сборка страницы приложения
